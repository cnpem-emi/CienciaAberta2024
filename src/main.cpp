...
OpticalSensor sensor1(SENSOR_1_PIN, SENSOR_1_OUTPUT, PULSE_WIDTH_MS, MODE);
OpticalSensor sensor2(SENSOR_2_PIN, SENSOR_2_OUTPUT, PULSE_WIDTH_MS, MODE);
OpticalSensor sensor3(SENSOR_3_PIN, SENSOR_3_OUTPUT, PULSE_WIDTH_MS, MODE);
OpticalSensor sensor4(SENSOR_4_PIN, SENSOR_4_OUTPUT, PULSE_WIDTH_MS, MODE);
OpticalSensor sensor5(SENSOR_5_PIN, SENSOR_5_OUTPUT, PULSE_WIDTH_MS, MODE);
OpticalSensor sensor6(SENSOR_6_PIN, SENSOR_6_OUTPUT, PULSE_WIDTH_MS, MODE);

ButtonControl btn(PULSE_WIDTH_MS);
